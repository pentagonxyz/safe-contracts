    ...
    function checkNSignatures(bytes32 dataHash, bytes memory signatures, uint256 requiredSignatures) public view {
        ...
        for (i = 0; i < requiredSignatures; i++) {
            ...
            if (v == 0) {
                ...
                /* solhint-enable no-inline-assembly */
                // NOTE: The following line is copied from the commit `1cfa95710057e33832600e6b9ad5ececca8f7839` to `safe-global/safe-contracts`; in `safe-contracts` version `v1.4.0`, from which this repository has been forked, a legacy implementation of EIP-1271 is used
